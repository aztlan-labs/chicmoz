import { ChicmozVerifiedContractAddressData } from "@chicmoz-pkg/types";

export const CHAIN_NAME = "AZTEC";
export const SERVICE_NAME = "explorer-api";

export type VerifiedAddresses = Record<string, ChicmozVerifiedContractAddressData>;

export const DEFAULT_VERIFIED_CONTRACT_ADDRESSES_DEV: VerifiedAddresses = {
...
export const DEFAULT_VERIFIED_CONTRACT_ADDRESSES_PROD: VerifiedAddresses = {
